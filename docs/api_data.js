define({ "api": [
  {
    "type": "get",
    "url": "/AnimeByState/:state/:sortBy/:page",
    "title": "Get list of Anime in tv",
    "version": "1.0.5",
    "name": "GetAnimeByState",
    "group": "AnimeByState",
    "success": {
      "fields": {
        "Success 200": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "page",
            "description": "<p>Total page unknown</p>"
          }
        ]
      }
    },
    "description": "<p>{state = 1} In Emission | {state = 2} Finalized | {state = 3} Coming Soon</p>",
    "filename": "./src/api/routes/index.js",
    "groupTitle": "AnimeByState"
  },
  {
    "type": "get",
    "url": "/AnimeCharacters/:title",
    "title": "Get list of characters from a particular anime",
    "version": "1.0.5",
    "name": "GetAnimeCharacters",
    "group": "AnimeCharacters",
    "success": {
      "fields": {
        "Success 200": [
          {
          ...
          },
          {
            ...
            "description": "<p>Character specific role</p>"
          }
        ]
      },
      "examples": [
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "You should use the `title` property of the anime.",
          "content": "{\n  \"title\": \"Tokyo Ghoul\",\n}",
          "type": "json"
        }
      ]
    ...
    "filename": "./src/api/routes/index.js",
    "groupTitle": "AnimeCharacters"
  },
  {
    "type": "get",
    "url": "/AnimeTrailers/:title",
    "title": "Get ist of promotional videos",
    "version": "1.0.5",
    "name": "GetAnimeTrailers",
    "group": "AnimeTrailers",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "get",
    "url": "/Genres/:genre/:sortBy/:page",
    "title": "Get list of Anime by genres",
    "version": "1.0.5",
    "name": "GetGenres",
    "group": "Genres",
    "success": {
  ...
  {
    "type": "get",
    "url": "/GetAnimeInfo/:id/:title",
    "title": "Get list of promotional videos",
    "version": "1.0.5",
    "name": "GetAnimeInfo",
    "group": "GetAnimeInfo",
    "success": {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "You should use the `title` and the 'id' property of the anime.",
          "content": "{\n  \"id\": \"anime/5226/tokyo-ghoul\",\n  \"title\": \"Tokyo Ghoul\"\n}",
          "type": "json"
        }
      ]
  ...
  },
  {
    "type": "get",
    "url": "/Search/:query",
    "title": "Get anime list by doing a search",
    "version": "1.0.5",
    "name": "Search",
    "group": "Search",
    "success": {
  ...
  {
    "type": "get",
    "url": "/Special/:sortBy/:page",
    "title": "Get list of Special Anime",
    "version": "1.0.5",
    "name": "GetSpecial",
    "group": "Special",
    "success": {
